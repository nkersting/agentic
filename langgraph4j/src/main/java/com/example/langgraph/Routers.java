...
public class Routers {
     ...
     */
    public static Function<State, String> routeAfterScaryCheck() {
        return state -> {
     ...
     */
    public static Function<State, String> routeAfterCreateInstructions() {
        return state -> {
            int retryCount = state.getRetryCount();
            int maxRetries = state.getMaxRetries();
            ...
            if (terminateFlag) {
                ...
                return "storyNode"; // Loop back to generate story
            }
        };
    }
     ...
     */
    public static Function<State, String> routeAfterFunninessCheck() {
        return state -> {
            int retryCount = state.getRetryCount();
            int maxRetries = state.getMaxRetries();
